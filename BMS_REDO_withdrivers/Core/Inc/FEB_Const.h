...
#define FEB_CONFIG_CELL_SOFT_MAX_VOLTAGE_mV 4100
...
#define FEB_CONFIG_PACK_SOFT_MAX_VOLTAGE_V 	FEB_NBANKS * FEB_NUM_ICPBANK * FEB_NUM_CELLS_PER_IC * FEB_CONFIG_CELL_SOFT_MAX_VOLTAGE_mV
