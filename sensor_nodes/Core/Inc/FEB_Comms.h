...
// Node Configuration
#define IS_FRONT_NODE 0        // 1 for front node, 0 for rear node
...
#define TIRETEMP 0             // Tire Temperature Sensors (IRTS-V3 on CAN2)
#define ADCS 1                 // ADC Sensors (Linear Pots, Strain Gauges, etc.)
